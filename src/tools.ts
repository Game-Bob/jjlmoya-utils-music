...
export const ALL_TOOLS: ToolDefinition[] = [METRONOME_TOOL, BPM_CALCULATOR_TOOL, PHASE_DISTANCE_TOOL, FREQUENCY_NOTE_CONVERTER_TOOL, AUDIO_STORAGE_CALCULATOR_TOOL, MUSIC_NOTE_EQUIVALENCY_TOOL, GUITAR_STRING_TENSION_CALCULATOR_TOOL, SETLIST_RUNTIME_CALCULATOR_TOOL];
