...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "中世における 'B-quadratum'（スクエアB）の表記の変化によるものです。ドイツ語圏では、HはナチュラルのB（シ）を指し、BはフラットのB（シ♭）のみを指すために使用されます。",
  },
  {
...
export const content: ToolLocaleContent<MusicNoteEquivalencyUI> = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: '時を経て、ドイツの写本では <em>B quadratum</em> の形が小文字の h にどんどん似ていきました。この視覚的な変化が印刷技術によって固定され、現在のドイツ式名称（ナチュラルのシはH、フラットのシはB）が誕生しました。興味深いことに、この区別があったおかげで、J.S.バッハのような作曲家は有名な「B-A-C-H」の主題（シ♭ - ラ - ド - シ♮）を使って自分の作品に署名することができました。',
    },
    {
      type: 'title',
      text: '幹音の対応比較表',
    ...
    {
      type: 'paragraph',
      html: '西洋音楽では、1オクターブにつき12の音を使用します。5つの追加の音は、変化記号であるシャープ（#）やフラット（♭）で表されます。シャープは音を半音上げ、フラットは半音下げます。',
    },
    {
      type: 'paragraph',
