...
const faqData = [
  ...
  },
  {
    ...
    answer:
      "중세 시대 'B-quadratum'의 그래픽적 진화 때문입니다. 독일어권 국가에서는 H를 내추럴 B(시)에 사용하고, B는 플랫 B(시(flat)) 전용으로 사용합니다.",
  },
  {
...
export const content: ToolLocaleContent<MusicNoteEquivalencyUI> = {
  ...
  seo: [
    ...
    {
      type: 'paragraph',
      html: '시간이 흐르면서 독일 필사본에서 <em>B quadratum</em>의 모양이 점점 소문자 h와 닮아가게 되었습니다. 이러한 시각적 변화가 인쇄 기술을 통해 고착화되면서 현재의 독일식 명칭인 내추럴 시는 H, 플랫 시는 B가 탄생했습니다. 흥미롭게도 이러한 구분 덕분에 요한 제바스티안 바흐와 같은 작곡가들은 유명한 "B-A-C-H" 동기(시(flat) - 라 - 도 - 시(natural))를 사용하여 자신의 작품에 서명할 수 있었습니다.',
    },
    {
      type: 'title',
      text: '원음 대응 비교표',
    ...
    {
      type: 'paragraph',
      html: '서양 음악에서는 한 옥타브당 12개의 소리를 사용합니다. 5개의 추가 음은 변화 기호인 샵(#)과 플랫((flat))으로 나타냅니다. 샵은 음을 반음 올리고, 플랫은 반음 내립니다.',
    },
    {
      type: 'paragraph',
