...
const UTILITY_ASSET_ROOT = "/_utilities/music";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/music/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/music/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("music");
